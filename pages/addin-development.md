...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="Fody" Version="5.0.1" PrivateAssets="None" />
    <PackageReference Include="FodyPackaging" Version="5.0.1" PrivateAssets="All" />
  </ItemGroup>
</Project>
```
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="FodyHelpers" Version="5.0.1" />
  </ItemGroup>
</Project>
```
...
```
<sup>[snippet source](/BasicFodyAddin/Tests/Tests.csproj#L1-L17)</sup>
<!-- endsnippet -->
